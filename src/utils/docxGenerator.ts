  ...
  const doc = new Document({
    sections: [{
      ...
      children: [
        ...
        ...[
          "Модернизация установленного домофонного оборудования с заменой на «умный» IP-домофон за счет компании ООО «Домофондар» (центральный блок вызова, блоки питания, коммутаторы, считыватели, замки, доводчики) — бесплатно.",
