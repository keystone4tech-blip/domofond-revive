        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground leading-relaxed mb-3">
              ООО «ДомофонДар» — Профессиональная установка, модернизация и техническое обслуживание домофонных систем, видеодомофонии и СКУД (7 лет в Краснодаре, более 20 лет опыта по Югу России).
            </p>
